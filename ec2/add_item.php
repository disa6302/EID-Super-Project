...
<head>
  ...
  <link href="add_item.css" type="text/css" rel="stylesheet">
</head>
...
<body>
  ...
  <div class="row">
    <div class="col-sm-6 col-sm-offset-3 form-box">
		<div class="form-top">
			<div class="form-top-left">
			  <p>Enter details of item to be added</p>
			</div>
		  </div>
        <form role="form" action="itemadd_process.php" method="POST" class="login-form" id="item-form">
	...
	<br />
            ...
            <input type="text" name="form-cost" placeholder="Enter Cost in $ per lb" class="form-cost" "form-control" id="form-cost">
	<br />
		...
		<option value="Pulses">Pulses</option>
          	...
          	<div class="form-group-btn" form="item-form">
